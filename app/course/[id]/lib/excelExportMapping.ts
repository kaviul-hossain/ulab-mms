...
export const DEFAULT_EXCEL_EXPORT_MAPPING: ExcelExportMapping = {
  ...
  singleCells: [
    ...
    { field: 'weight.attendance', cell: 'C64' },
    { field: 'weight.classPerformance', cell: 'C65' },
    { field: 'weight.quiz', cell: 'C66' },
    { field: 'weight.assignment', cell: 'C67' },
    { field: 'weight.midterm', cell: 'C68' },
    { field: 'weight.project', cell: 'C69' },
    { field: 'weight.final', cell: 'C70' },
  ],
  rangeMappings: [
